...
namespace Issho
{
    public class EnemyLeftRight : GravityItemLeftRight
    {
        ...
        public EnemyLeftRight(Vector2 position, int distance = 100, 
            ...
            base(position)
        {
            ...
            startPoint = Position.X;
            endPoint = Position.X + this.distance;

            this.Tag((int)GameTags.EnemyLeftRight);
