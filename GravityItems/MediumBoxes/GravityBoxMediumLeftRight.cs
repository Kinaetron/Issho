...
namespace Issho
{
    ...
    public class GravityBoxMediumLeftRight : GravityItemLeftRight
    {
        public GravityBoxMediumLeftRight(Vector2 position) :
            base(position)
        {
            this.Tag((int)GameTags.GravityBoxMediumLeftRight);
