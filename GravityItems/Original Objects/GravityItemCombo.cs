...
namespace Issho
{
    public class GravityItemCombo : GravityItem
    {

        public GravityItemCombo(Vector2 position) :
            base(position)
        {
            this.Add(counters);
        }
        ...
        protected override void GravityPull()
        {
            ...
            if (Direction == GravityDirection.Down && counterStart == true)
            {
                arrowDown = Color.Red;
                Done = true;
            ...
            else if (Direction == GravityDirection.Up && counterStart == true)
            {
                arrowUp = Color.Red;
                Done = true;
            ...
            else if (Direction == GravityDirection.Right && counterStart == true)
            {
