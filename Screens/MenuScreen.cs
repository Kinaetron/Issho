...
namespace Issho.Screens
{
    abstract class MenuScreen : GameScreen
    {
        ...
        protected SoundEffect menuUp;
        protected SoundEffect menuDown;
        ...
        public MenuScreen(string menuTitle)
        {
            ...
            menuUp = Engine.MenuContentManager.Load<SoundEffect>("Sounds/Effects/menuSoft0");
            menuDown = Engine.MenuContentManager.Load<SoundEffect>("Sounds/Effects/menuSoft1");
            menuSelect = Engine.MenuContentManager.Load<SoundEffect>("Sounds/Effects/menuHard0");
        }
